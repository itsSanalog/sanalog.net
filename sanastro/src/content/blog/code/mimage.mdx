...
Source is on <a href="https://github.com/itsSanalog/sanalog.net/blob/main/sanastro/src/scripts/apps/mimagePlus/stretchgrid.js" target="_blank" class="extlink">GitHub</a>.
