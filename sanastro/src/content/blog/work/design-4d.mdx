...
sortOrder: 4
---
import ThemeImage from '../../../components/blog/ThemedImage.astro';
import parts from '../../../assets/blog/work/design-4d/parts.png';
import bad from '../../../assets/blog/work/design-4d/bad.png';
import bad1 from '../../../assets/blog/work/design-4d/bad1.png';
import arrange from '../../../assets/blog/work/design-4d/arrange.png';


Say you have to make a pocket radio. You have to include a circuit board, a speaker, and two AA batteries.

<ThemeImage src={parts} alt="Parts diagram" />

<p class="small muted c">a circuit board, a speaker, and two AA batteries</p>

You might go with an arrangement like this:

<ThemeImage src={bad1} alt="Parts diagram" />
...
<ThemeImage src={bad} alt="Parts diagram" />

But following good design principles, you will probably end up with this: 

<ThemeImage src={arrange} alt="Parts diagram" />
